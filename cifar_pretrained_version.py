...
def prepare_dataloader(num_workers=8,
    ...
    imagenet_datapath = "/home/wangzy/project/DATA/ILSVRC2012_img_val"
...
def main():
    ...
    quantized_model_filename = "resnet18_quantized_pretrained.pt"
    model_filepath = os.path.join(model_dir, model_filename)
    ...
    fused_model = fuse_model_18( fused_model )
